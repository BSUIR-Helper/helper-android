...
public class DialogFragmentAddGroup extends DialogFragment {
    ...
    ActivityManagerGroups.ScheduleAsyncTask mScheduleAsyncTask;

    public DialogFragmentAddGroup(ScheduleManager scheduleManager, ActivityManagerGroups.ScheduleAsyncTask asyncTask) {
        mScheduleManager = scheduleManager;
        mScheduleAsyncTask = asyncTask;
    }
                ...
                .setPositiveButton("Добавить", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!isConnected) {
                            ...
                            mScheduleAsyncTask.execute(etAddGroup.getText().toString());
                        }
                    }
                })
