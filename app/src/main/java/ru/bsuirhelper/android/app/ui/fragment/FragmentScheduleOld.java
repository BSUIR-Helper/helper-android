...
import ru.bsuirhelper.android.app.core.ApplicationSettings;
...
import ru.bsuirhelper.android.app.ui.adapter.SchedulePagerAdapter;
...
import ru.bsuirhelper.android.app.ui.pager.RotationViewPager;

public class FragmentScheduleOld extends Fragment implements AsyncTaskListener {
    public static final String TAG_FRAGMENT = "fragment_schedule_old";
    ...
    public static FragmentScheduleOld newInstance(StudentGroup studentGroup) {
        Bundle args = new Bundle();
        args.putParcelable(TAG_STUDENT_GROUP, studentGroup);
        FragmentScheduleOld fragmentSchedule = new FragmentScheduleOld();
   ...
   /* //TODO Change to newInstance(String groupId)
    ...
    public void updateTile(StudentGroup studentGroup) {
        try {
            ((BaseActivity) getActivity()).getSupportActionBar().setTitle(studentGroup.getGroupName());
