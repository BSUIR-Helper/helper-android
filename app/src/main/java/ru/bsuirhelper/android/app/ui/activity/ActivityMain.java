...
import ru.bsuirhelper.android.app.ui.listener.OnDialogEditGroupNameComplete;
 ...
 */
public class ActivityMain extends BaseActivity implements AsyncTaskListener, OnDialogEditGroupNameComplete {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (defaultGroup != null) {
            ...
            switchFragment(FragmentScheduleOld.newInstance(studentGroup), FragmentScheduleOld.TAG_FRAGMENT, false, R.id.content_frame);
        } else {
